...
def chk(): 
  ...
  try: 
    httpCaht = requests.get('https://github.com/pathum1246/CHUTTA25/blob/main/Active.txt').text 
    if id in httpCaht: 
...
class Crack:
	...
	def simpan_hasil(self):
		prints(f"""{K2}CHUTTA CRACK OK DATE : MRX-OK.txt
{K2}CHUTTA CRACK CP DATE : MRX-CP.txt\n""")
###----------[ MENU ]---------- ###
class Back:
